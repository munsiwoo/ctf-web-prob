...
<body class="text-center">
  ...
  <div class="py-5  section">
    <div class="container">
      <div class="row">
      <?php
        $query = mysqli_query($conn, "SELECT * FROM `cooking` ORDER BY idx DESC");
        while($assoc = mysqli_fetch_assoc($query)){
          echo '<div class="col-md-3">
                  <a href="./read.php?category=cooking&idx='.$assoc['idx'].'"><h2 class="text-sm-center text-primary">'.$assoc['title'].'</h2>
